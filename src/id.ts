 ...
 */
function prefixedTimestampId(prefix: string): string {
...
class IncrementalId {
  ...
  constructor(start: number = 1, prefix: string = '') {
    this.counter = start
    this.prefix = prefix
  }
 ...
 */
function createIncrementalId(start: number = 1, prefix: string = ''): IncrementalId {
 ...
 */
function generateBatch(count: number, generator: () => string = uuid): string[] {
